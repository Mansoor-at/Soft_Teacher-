...
conduct() {
  ...
  for percent in 1 5 10; do
      for fold in 1 2 3 4 5; do
          python /raid/home/A01753093/SoftTeacher/tools/dataset/semi_coco.py --percent ${percent} --seed ${fold} --data-dir /raid/home/A01753093/SoftTeacher/tools/dataset/data/coco/ --seed-offset ${OFFSET}
      done
  done
}
