...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type="CocoDataset",
            classes= classes,
            ann_file="/raid/home/A01753093/SoftTeacher/tools/dataset/data/coco/annotations/instances_train2017.json",
    ...
    val=dict(classes =classes,
        ann_file='path/to/your/val/instances_val2017.json',
        img_prefix='/raid/home/A01753093/SoftTeacher/tools/dataset/data/coco/val2017/',
